...
export default function Home() {
  return (
    <div>
      ...
      <section className="min-h-[90vh] px-8 relative flex flex-col items-center gap-6 overflow-visible pt-32 lg:pt-36 before:w-full before:absolute before:-top-16 before:h-64 before:bg-gradient-to-b before:from-[#1D1D1D] before:to-transparent">
        <svg
        ...
        <div className="relative z-10 flex w-full flex-col items-center">
          ...
          >
            ...
            />
            <path
            className='animate-slow-bounce duration-1000 origin-center'
              fill="#474DFF"
            ...
            />
            <g filter="url(#b)" opacity=".7" className='animate-slow-bounce duration-1000 origin-center'>
              <path
                fill="#000"
                fillOpacity=".4"
            ...
            <g filter="url(#c)" opacity=".7" className='animate-slow-bounce duration-1000 origin-center'>
              <path
                fill="#000"
                fillOpacity=".4"
